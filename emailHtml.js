function fn(weatherData, lifeData, content, imgurl, lovingDays) {
  ...
  return `<!DOCTYPE html>
    <html lang="en">
      ...
      <body>
      <div style="font-size: 0.5rem;width: 100%;height: 100%;overflow-y: scroll;box-sizing: border-box;border:1px solid rgba(0, 0, 0, 0.5);">
        <!-- 天数 -->
        ...
        <!-- 每日一句 -->
        <div style="font-size: 1rem;text-indent: 2em;font-style: italic;color: #000000;text-align:center;padding: 1.5px 1px;">
          ${content}
        </div>
        <!-- 天气 -->
