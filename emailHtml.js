  ...
  return `<!DOCTYPE html>
    <html lang="en">
      ...
      <div style="width: 100%;height: 100%;overflow-y: scroll;box-sizing: border-box;border:1px solid rgba(0, 0, 0, 0.5);">
        <!-- 天数 -->
        <div style="font-size: 2px;font-weight: bold;line-height: 2;padding: 1rem;margin: 1rem;border-radius: 1rem 0.5rem;text-align: center;position: relative;color: #000000;margin-bottom: 2px;letter-spacing: 0.2rem;">
        ...
        <!-- 每日一句 -->
        <div style="font-size: 1.6rem;text-indent: 2em;font-style: italic;color: #000000;text-align:center;padding: 1.5px 1px;">
          ${content}
        </div>
        <!-- 天气 -->
