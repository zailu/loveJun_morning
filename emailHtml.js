  ...
  return `<!DOCTYPE html>
    <html lang="en">
      ...
      <div style="font-size: 1rem;width: 100%;height: 100%;overflow-y: scroll;box-sizing: border-box;border:1px solid rgba(216, 131, 197, 0.5);">
        ...
        <!-- 每日一句 -->
        <div style="font-size: 1rem;text-indent: 2em;font-style: italic;padding: 3rem 2rem;background: url(https://s3.bmp.ovh/imgs/2022/02/12afbf3edaeb00ca.png) no-repeat center top;background-size: 90% 100%;">
        ...
        <div style="font-size: 1rem;padding: 1.2rem 1rem;">
			<div style="font-weight: bold;color: #000000;padding: 1rem 1rem;">
				...
				深圳今日气温:${weatherDataDaily[0].tempMin}°C - ${weatherDataDaily[0].tempMax}°C
			</div>
